window.onload = function init() {
  ...
  const newModelPath = "../../move_cat/umbrella/scene.gltf";
  const normalMapTexturePath =
    "../../move_cat/umbrella/textures/Material.001_normal.png";
  const baseColorTexturePath =
    "../../move_cat/umbrella/textures/Material.001_baseColor.png";
